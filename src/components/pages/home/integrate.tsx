...
const subPanels = [
  {
    name: 'Javascript',
    link: 'https://runkit.com/stormtv/payid-javascript',
  },
  {
    name: 'Swift',
  ...
  return (
    <>
      <div className="w-full">
        <div className="h-48 px-10 py-20 border bg-gradient-b-gray rounded-t-md border-gray-50">
          <img src={withPrefix(logo)} className="w-auto h-8 m-auto" />
        </div>
        <div className="h-48 border border-gray-50 rounded-b-md">
        ...
        <div className="flex w-full">
          <img src={withPrefix(userImage)} className="mt-6 mr-5 rounded-full" />
...
const Integrate: React.FC = () => {
  ...
  return (
    <Wave background="white" wave="gray" no-gutter>
      ...
      <div className="md:flex">
        ...
        <div className="w-full overflow-hidden ">
          ...
          {activePanel === 'Xpring SDK' && (
            <>
              <div className="mt-6 mb-16 font-mono text-sm font-normal text-white rounded md:mt-8">
          ...
          {developerDetails.map((detail, idx) => {
            return (
              ...
              >
                ...
                />
                <div
                  className="flex items-center w-full h-12 px-3 py-4 align-middle bg-white rounded shadow-lg sm:h-16"
                  onClick={() => {
      ...
      <div className="flex items-center justify-center w-full mt-24 text-center md:mt-32 mb-36 lg:h-94">
        <div
        ...
        >
          <Discord className="m-auto mt-16" />
          <h1 className="mt-10 text-3xl font-bold">Join Discord Community</h1>
          <Button label="Join Discord" className="mt-10 mb-10" />
        </div>
      </div>
    </Wave>
  )
